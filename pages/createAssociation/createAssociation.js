        ...
        .then(function (response) {
          if (response.statusCode == 200) {
            ...
            if (response.data.code == 1) {
              ...
              //创建社群成功后   创建群聊
              // utils.sendRequest(app.globalData.publicAdress + 'api/Im/establish_flock?user_id=' + ("1400255392" + wx.getStorageSync("userId")) + '&id=' + response.data.data.id, 'post')
              //   .then(function (response) {
              //     if (response.statusCode == 200) {
              //       //成功
