...
Page({
  ...
  getList(page, name, type) {
    ...
    utils.sendRequest(app.globalData.publicAdress + 'addons/cms/wxapp.index/channelList?page=' + that.data.page + '&name=' + that.data.name + '&type=' + that.data.type, 'get')
  ...
  wxSearchConfirm: function (e) {
    ...
    that.setData({
      name: e.detail.value['search - input'] ? e.detail.value['search - input'] : e.detail.value
    })
    that.getList(that.data.page, that.data.name, that.data.type);
  },
  close:function(){
